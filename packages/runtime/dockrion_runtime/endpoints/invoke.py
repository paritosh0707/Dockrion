...
import json
import asyncio
from typing import AsyncGenerator, Callable, Awaitable, Union, Type, Dict, Any
...
def create_invoke_router(
    ...
    async def invoke_agent(
        ...
        try:
            ...
            payload_dict: Dict[str, Any] = payload.model_dump() if hasattr(payload, 'model_dump') else payload.dict()  # type: ignore[attr-defined]
